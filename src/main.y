...
%token ASS PLUS_ASSIGN MIN_ASSIGN TIM_ASSIGN DIV_ASSIGN MOD_ASSIGN
...
statements
:  statement {$$=$1;$$->scope=$1->scope;}
|  statement statements {$$=$1; $1->addSibling($2);$$->scope=$1->scope;}
|  LB statements RB {$$=$2;$$->scope=$2->scope;}
;
...
declaration
: T IDENTIFIER ASS expr{  // declare and init
    TreeNode* node = new TreeNode($1->lineno, NODE_STMT);
