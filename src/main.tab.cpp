...
#line 1 "src/main.y" /* yacc.c:339  */
    ...
    TreeNode* root;
    DomainTreeNode* sco=new DomainTreeNode();
    extern int lineno;
    int yylex();
...
{
       0,    43,    43,    47,    48,    49,    53,    64,    65,    66,
      67,    68,    69,    70,    71,    72,    73,    74,    75,    76,
      80,    81,    85,    86,    90,    96,   102,   108,   114,   120,
     129,   142,   154,   158,   161,   164,   167,   170,   173,   176,
     179,   182,   188,   200,   208,   218,   219,   223,   231,   237,
     241,   242,   246,   247,   251,   259,   267,   268,   271,   280,
     290,   301,   315,   316,   321,   329,   330,   334,   341,   349,
     350,   351,   352,   353,   354,   355,   356,   357,   358,   359,
     360,   361,   362,   363,   364,   365,   366,   367,   368,   369,
     370,   371,   372,   373,   374,   375,   379,   380,   381,   382,
...
static const char *const yytname[] =
{
  ...
  "T_DOUBLE", "T_VOID", "ASS", "PLUS_ASSIGN", "MIN_ASSIGN", "TIM_ASSIGN",
  "DIV_ASSIGN", "MOD_ASSIGN", "SEMICOLON", "LB", "RB", "COMMA", "LP", "RP",
  "IDENTIFIER", "INTEGER", "CHAR", "BOOL", "STRING", "NUMBER", "PLUS",
  "MINUS", "TIMES", "DIVIDE", "MOD", "PPLUS", "MMINUS", "AND", "OR", "NOT",
  "EQU", "GTR", "LSS", "GEQ", "LEQ", "NEQ", "LOGICAL_AND", "LOGICAL_OR",
  "LOGICAL_NOT", "UMINUS", "FOR", "INPUT", "OUTPUT", "DO", "MAIN", "IF",
  "ELSE", "WHILE", "RETURN", "SCANF", "PRINTF", "EOL", "LOP_EQ", "XOR",
...
#line 47 "src/main.y" /* yacc.c:1646  */
    {(yyval)=(yyvsp[0]);(yyval)->scope=(yyvsp[0])->scope;}
#line 1616 "src/main.tab.cpp" /* yacc.c:1646  */
    break;

  case 4:
#line 48 "src/main.y" /* yacc.c:1646  */
    {(yyval)=(yyvsp[-1]); (yyvsp[-1])->addSibling((yyvsp[0]));(yyval)->scope=(yyvsp[-1])->scope;}
#line 1622 "src/main.tab.cpp" /* yacc.c:1646  */
    break;

  case 5:
#line 49 "src/main.y" /* yacc.c:1646  */
    {(yyval)=(yyvsp[-1]);(yyval)->scope=(yyvsp[-1])->scope;}
...
#line 53 "src/main.y" /* yacc.c:1646  */
    ...
    (yyval) = (yyvsp[-3]);
    DomainTreeNode* sc=new DomainTreeNode();
    sco->addChild(sc);
    sco=sco->child;
    }
...
#line 394 "src/main.y" /* yacc.c:1906  */
